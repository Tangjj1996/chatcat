...
const Display: React.FC = () => {
  ...
  const sessionPanel = clienData.map((client, index) => {
    if (index <= serverData.length - 1) {
      return (
        <>
          <div className="m-auto flex flex-col md:w-[600px]">
            <svg
          ...
          <div className="m-auto flex flex-col md:w-[600px]">
            ...
            >
              ...
              <path
                fill="url(#9yv_OTO3P9eepfu7Rtqera)"
              ...
              <path
                fill="url(#9yv_OTO3P9eepfu7Rtqerb)"
  ...
  return <div className="h-full w-full pt-5">{sessionPanel}</div>;
};
